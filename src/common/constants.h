...
constexpr uint32_t CHUNK_SIZE_PADDED = CHUNK_SIZE + 2;
constexpr uint32_t CHUNK_SIZE_PADDED_2 = CHUNK_SIZE_PADDED * CHUNK_SIZE_PADDED;
constexpr uint32_t CHUNK_SIZE_PADDED_3 = CHUNK_SIZE_PADDED * CHUNK_SIZE_PADDED * CHUNK_SIZE_PADDED;
